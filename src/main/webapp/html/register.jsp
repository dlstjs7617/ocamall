...
<header>
    ...
    <div class="middle_menu">
      <div class="middle_menu_inner">
        <h1>
          <a href="index.html">CAMPMALL</a>
        </h1>
        <ul>
          <li>
            <a href="#"><strong>NOTICE</strong></a>
          </li>
          <li>
            <a href="#">EVENT</a>
          </li>
        ...
        <form id="register_form" action="${contextPath}/register/addMember.do" method="post">
          <fieldset>
            ...
            <div class="input_box">
              ...
              <input type="text" name="phone1" id="phone_1" class="input_phone" maxlength="3" required> -
              <input type="text" name="phone2" id="phone_2" class="input_phone" maxlength="4" required> -
              <input type="text" name="phone3" id="phone_3" class="input_phone" maxlength="4" required>
            </div>
            <div class="input_box">
              <p class="title">
