...
<head>
  ...
  <script src="${contextPath}/js/find.js"></script>
</head>
        ...
        <form action="#">
          <fieldset>
            ...
            <div class="input_box">
              ...
              <input type="text" class="input_name" required>
            </div>
            <div class="input_box">
              <p class="title">
            ...
            <div class="input_box">
              ...
              <input type="text" class="input_phone" placeholder="예) 01012345678" required>
            </div>
            <a href="#" class="btn_member">비밀번호 찾기</a>
          </fieldset>
        </form>
      </div>
    </section>
